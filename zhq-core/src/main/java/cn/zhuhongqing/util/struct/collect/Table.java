...
import cn.zhuhongqing.anno.KeyAlias;
...
public interface Table<R, C, V> {
   ...
   */
  boolean contains(
		  @KeyAlias("R") Object rowKey,
		  @KeyAlias("C") Object columnKey);
   ...
   * @param rowKey key of row to search for
   */
  boolean containsRow( @KeyAlias("R") Object rowKey);
   ...
   * @param columnKey key of column to search for
   */
  boolean containsColumn( @KeyAlias("C") Object columnKey);
   ...
   */
  boolean containsValue( @KeyAlias("V") Object value);
