...
public class LocaleUtils {
	 ...
	 * @see LocaleUtils#getShortTimeZone(Date)
	 */

	public static String getShortTimeZone() {
		return getShortTimeZone(DateUtils.getCurrentDate());
	}

	/**
	 * @param date
	 *            judge isInDaylightTime
	 * @see LocaleUtils#getTimeZone()
	 * @see LocaleUtils#getLocale()
	 * @see LocaleUtils#getShortTimeZone(Date, TimeZone, Locale)
	 */

	public static String getShortTimeZone(Date date) {
		return getShortTimeZone(date, TimeZoneUtils.getTimeZone(), getLocale());
	}
	...
	/**
	 * @see DateUtils#getCurrentDate()
	 * @see LocaleUtils#getLongTimeZone(Date)
	 */

	public static String getLongTimeZone() {
		return getLongTimeZone(DateUtils.getCurrentDate());
	}

	/**
	 * @see LocaleUtils#getTimeZone()
	 * @see LocaleUtils#getLocale()
	 * @see LocaleUtils#getLongTimeZone(Date, TimeZone, Locale)
	 */

	public static String getLongTimeZone(Date date) {
		return getLongTimeZone(date, TimeZoneUtils.getTimeZone(), getLocale());
	}
