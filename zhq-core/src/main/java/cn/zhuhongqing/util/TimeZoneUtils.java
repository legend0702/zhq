...
public class TimeZoneUtils {
	...
	public static String getGMTTimeZoneID(String gmt) {
		return TimeZone.getTimeZone(StringUtils.startPad(gmt, GMT)).getID();
	}

	/**
	 * @see TimeZoneUtils#getTimeZone(TimeZone)
	 */
	...
	public static String getRFC822TimeZone(Calendar calendar) {
		...
		buffer.append(StringUtils.forwardFilling4((int) (value * 100)));
