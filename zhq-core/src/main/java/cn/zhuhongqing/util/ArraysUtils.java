...
import static cn.zhuhongqing.util.StringPool.NULL;
...
public final class ArraysUtils {
	...
	/**
	 * Converts an array to string. Elements are separated by comma and an empty
	 * space. Returned string contains no brackets.
	 */
	...
	public static <T> Set<T> toSet(T[] objs) {
		...
		HashSet<T> hSet = new HashSet<>(objs.length);
		for (T o : objs)
			hSet.add(o);
		return hSet;
	}
	...
	public static <T> List<T> toList(T[] objs) {
		...
		ArrayList<T> hSet = new ArrayList<>(objs.length);
		for (T o : objs)
			hSet.add(o);
		return hSet;
	}
