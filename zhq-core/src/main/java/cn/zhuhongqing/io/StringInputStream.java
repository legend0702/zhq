...
/**
 * Simple <code>InputStream</code> to fetch bytes from a String. There are 3
 * modes how bytes can be processed:
 * <ul>
 * <li><code>ALL</code> - all bytes are returned: both high and low byte of each
 * character</li>
 * <li><code>STRIP</code> - only low byte of each character is returned</li>
 * <li><code>ASCII</code> - only low byte of each character is returned, but
 * overloaded chars are marked with 0x3F</li>
 * </ul>
 */
public class StringInputStream extends InputStream implements Serializable {

	private static final long serialVersionUID = 6305790590390307637L;
