...
public abstract class ObjectStateWithAttrHole<K, V> extends MapAttrHole<K, V> implements ObjectState {

	private String group;
	private ObjectScope scope;

	public ObjectStateWithAttrHole() {
		this(new HashMap<>());
	}

	public ObjectStateWithAttrHole(Map<K, V> instance) {
		super(instance);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ObjectStateWithAttrHole<?, ?> other = (ObjectStateWithAttrHole<?, ?>) obj;
		if (group == null) {
